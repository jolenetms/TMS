...
remission_met_1 = HAMD_by_session.remission_met(HAMD_by_session.remission_met ~= 0);
sg_ppt_1 = HAMD_by_session.sg_ppt(HAMD_by_session.sg_ppt ~= 0);

HAMD_by_session_array_all = table2array(HAMD_by_session);

rem_and_sg_instances = all(HAMD_by_session.sg_ppt == 1 & HAMD_by_session.remission_met == 1, 2);
